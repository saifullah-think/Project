...
class Breadcrumb extends Component {
    ...
    componentWillReceiveProps = () => {
        ...
        /////For Setting Page
        if(window.location.pathname === '/admin/profile-setting')
        {
            const obj ={
                id: "setting", title: "Setting", type: "item", url: "/profile-setting", icon: "feather icon-settings"
            }

            this.setState({item: obj, main: []});
        }
    };
